...
def normalize_events_to_csv(data):
    ...
    file_path=f'/Users/lisyue/Documents/GitHub/spark_etl_SY/godata2023/{file_creation_time}.csv'
...
if __name__ == '__main__':
    api = APIHandler(request_params=nvd_params)
    endpoint = api.get_endpoint()
    data = api.request_data(url=endpoint)
